...
class OpenTripMapParser(BaseParser):
    ...
    It performs the following steps:
      ...
      4. Uses WikipediaParser to fetch and add/update Wikipedia descriptions for each attraction.
      5. Will use Google Places API (further) (API key already in the conf.py)
    """
    ...
    def parse(self, place: str, radius: int = 10000, limit: int = 50,
        ...
        for feature in features:
            ...
            try:
                ...
                # Шаг 4: Парсинг описания из Википедии для текущего места
